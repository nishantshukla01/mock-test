...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here we define all paytm recommend credentials which provided by paytm for payment gateway.
    | We have to change all it in env so that it can b use whenever we use paytm payment gateway
    |
    */
